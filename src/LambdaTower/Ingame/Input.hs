module LambdaTower.Ingame.Input where
...
sdlKeyInputHandler :: InputHandler [PlayerEvent]
sdlKeyInputHandler = mapMaybe eventToPlayerEvent <$> SDL.pollEvents

eventToPlayerEvent :: SDL.Event -> Maybe PlayerEvent
eventToPlayerEvent event =
  case SDL.eventPayload event of
    SDL.KeyboardEvent keyEvent ->
      keyToPlayerEvent code motion
